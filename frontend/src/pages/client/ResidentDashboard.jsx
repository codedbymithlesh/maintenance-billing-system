    ...
    <div className="min-h-screen bg-gray-50/50 p-6 md:p-8">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Welcome Card */}
          <div className="md:col-span-1 bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col justify-between hover:shadow-md transition-all">
            <div>
            ...
            <div className="mt-4 flex items-center gap-2 text-xs font-medium text-emerald-600 bg-emerald-50 w-fit px-3 py-1.5 rounded-full">
               <User size={14} /> Account Verified
            </div>
          </div>

          {/* Stats: Total Due */}
          <div className="bg-rose-50 to-white p-6 rounded-2xl shadow-sm border border-red-100 relative overflow-hidden group hover:shadow-md transition-all">
          ...
          {/* Stats: Total Paid */}
          <div className="bg-emerald-50 to-white p-6 rounded-2xl shadow-sm border border-green-100 relative overflow-hidden group hover:shadow-md transition-all">
            <div className="absolute right-0 top-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
